...
export function RentArt() {
  return (
    <div className="max-w-5xl mx-auto p-8">
      <main className="flex flex-col items-center justify-center dark:bg-gray-800 py-10 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            genauere Informationen und ein individuelles Angebot kontaktiere
            mich gerrne!
          </p>
          <div className="mt-6">
